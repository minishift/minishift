...
var (
	...
	UpstreamProxy = createConfigSetting("upstream-proxy", SetString, []setFn{validations.IsValidProxy}, nil, true, nil)
	...
	ServicesProxyPort = createConfigSetting("services-proxy-port", SetInt, []setFn{validations.IsValidPort}, nil, true, nil)
