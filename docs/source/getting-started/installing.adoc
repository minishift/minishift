...
+
NOTE: xhyve requires specific installation and configuration steps that are described in the xref:../getting-started/setting-up-driver-plugin.adoc#set-up-driver-plugin[Setting Up the Driver Plug-in] section.
...
+
NOTE: KVM requires specific installation and configuration steps that are described in the xref:../getting-started/setting-up-driver-plugin.adoc#set-up-driver-plugin[Setting Up the Driver Plug-in] section.
...
[NOTE]
====
To use Minishift with Hyper-V ensure that, after you link:https://docs.microsoft.com/en-us/virtualization/hyper-v-on-windows/quick-start/enable-hyper-v[install Hyper-V], you also link:https://msdn.microsoft.com/en-us/virtualization/hyperv_on_windows/quick_start/walkthrough_virtual_switch[add a Virtual Switch] using the Hyper-V Manager.
For specific configuration steps see the xref:../getting-started/setting-up-driver-plugin.adoc#set-up-driver-plugin[Setting Up the Driver Plug-in] section.
====
...
If you encounter issues related to the hypervisor, see the xref:../using/troubleshooting.adoc#troubleshooting[Troubleshooting] section.
====
