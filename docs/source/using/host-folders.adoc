...
Minishift provides the xref:../command-ref/minishift_hostfolder.adoc#minishift-hostfolder[`minishift hostfolder`] command to list, add, mount, unmount and remove host folders.
...
The xref:../command-ref/minishift_hostfolder_list.adoc#minishift-hostfolder-list[`minishift hostfolder list`] command gives you an overview of the defined host folders, their names, mount points, remote paths and whether they are currently mounted.
...
The xref:../command-ref/minishift_hostfolder_add.adoc#minishift-hostfolder-add[`minishift hostfolder add`] command allows you to define a new host folder.
...
To do so, you can use the `instance-only` flag of the xref:../command-ref/minishift_hostfolder_add.adoc#minishift-hostfolder-add[`minishift hostfolder add`] command.
Host folder definition that are created with the `instance-only` flag will be removed together with any other instance-specific state during xref:../command-ref/minishift_delete.adoc#minishift-delete[`minishift delete`].

[[mounting-host-folders]]
=== Mounting Host Folders

After you add host folders, you use the xref:../command-ref/minishift_hostfolder_mount.adoc#minishift-hostfolder-mount[`minishift hostfolder mount`] command to mount a host folder by its name:
...
Host folders can also be mounted automatically each time you run xref:../command-ref/minishift_start.adoc#minishift-start[`minishift start`].
...
You use the xref:../command-ref/minishift_hostfolder_umount.adoc#minishift-hostfolder-umount[`minishift hostfolder umount`] command to unmount a host folder.
...
You use the xref:../command-ref/minishift_hostfolder_remove.adoc#minishift-hostfolder-remove[`minishift hostfolder remove`] command to remove a host folder definition.
