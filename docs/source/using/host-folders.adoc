...
Host folders can be shared using CIFS.
It is possible to use CIFS on Windows, macOS and Linux.
...
Via the `--options` flag the domain of the share can be specified as well.
