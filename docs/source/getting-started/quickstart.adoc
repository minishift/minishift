...
For details on the usage of Minishift, see the xref:../using/managing-minishift.adoc#managing-minishift[Managing Minishift] section.

The interaction with OpenShift is with the command-line tool _oc_ which is copied to your host.
For more information on how Minishift can assist you in interacting with and configuring your local OpenShift instance, see the xref:../openshift/openshift-client-binary.adoc#openshift-client-binary[OpenShift Client Binary] section.
...
For more information about `minishift start` options, see the xref:../command-ref/minishift_start.adoc#minishift-start[`minishift start`] command.
====

. Use xref:../command-ref/minishift_oc-env.adoc#minishift_oc-env[`minishift oc-env`] to display the command you need to type into your shell in order to add the *oc* binary to your `PATH` environment variable.
...
For more information about interacting with OpenShift with the command-line interface and the Web console, see the xref:../openshift/openshift-client-binary.adoc#openshift-client-binary[OpenShift Client Binary] section.
