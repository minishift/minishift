...
```
      ...
      --create-machine             Create a Docker machine if one doesn't exist
      ...
      --docker-machine string      Specify the Docker machine to use
  -e, --env value                  Specify key value pairs of environment variables to set on OpenShift container (default [])
      ...
      --image string               Specify the images to use for OpenShift (default "openshift/origin")
      ...
      --version string             Specify the tag for OpenShift images
