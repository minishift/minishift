...
To build {project} with system tray use the following command:

----
$ make systemtray
----

By default system tray is automatically started on running xref:../command-ref/minishift_start.adoc#[`minishift start`]. To disable the auto start behaviour use
