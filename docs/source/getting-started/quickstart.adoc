...
If any startup checks fail, see the xref:../using/troubleshooting.adoc#minshift-startup-check-failed[troubleshooting] topic for information about possible causes and solutions.
