...
- [Controlling runtime behavior of Minishift](controlling-runtime-behavior-of-minishift)
  - [Flags](flags)
...
<a name="controlling-runtime-behavior-of-minishift"></a>
## Controlling runtime behavior of Minishift
...
It will also set the `http-proxy`, `https-proxy` and `no-proxy`
