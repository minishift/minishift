...
- We recommend to use `Virtualbox >= 5.1.12` on Windows to avoid [known issue](./docs/troubleshooting.md/#troubleshooting.md#error-getting-state-for-host-machine-does-not-exist)
