...
func getOcShellConfig(api libmachine.API, forceShell string) (*OcShellConfig, error) {
	...
	shellCfg := &OcShellConfig{
		OcPath:    path.Dir(instanceState.InstanceConfig.OcPath),
...
var ocEnvCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		shellCfg, err = getOcShellConfig(api, forceShell)
		if err != nil {
