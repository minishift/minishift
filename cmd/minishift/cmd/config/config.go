...
var (
	...
	SkipCheckOpenShiftGithubRelease = createConfigSetting("skip-check-openshift-github-release", SetBool, nil, nil, true, nil)
	WarnCheckOpenShiftGithubRelease = createConfigSetting("warn-check-openshift-github-release", SetBool, nil, nil, true, false)
