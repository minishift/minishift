...
This command shuts down the Minishift virtual machine, but preserves the cluster state and data.
Starting Minishift again will restore the instance to it's previous state, allowing you to restart from where you left-off.
