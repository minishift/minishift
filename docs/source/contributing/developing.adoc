...
[NOTE]
====
See the link:https://docs.cucumber.io/gherkin/reference[Gherkin Reference] for more general information about the structure of Gherkin, its features, scenarios, and steps.
====
