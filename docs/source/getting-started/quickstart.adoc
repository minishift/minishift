...
For more information about the OpenShift cluster architecture, see link:https://docs.okd.io/latest/architecture/index.html[Architecture Overview] in the OpenShift documentation.
...
For more information about creating applications in OpenShift, see link:https://docs.okd.io/latest/dev_guide/application_lifecycle/new_app.html[Creating New Applications] in the OpenShift documentation.
